...
const NewsSection = () => {
    return (
        <div className='mt-9 ]'>
            ...
            <div className='grid grid-cols-3 gap-5 mt-10 p-6 bg-[#4B2E09] shadow rounded-2xl '>
                <div className='col-span-2 bg-[#F5F5DC] p-3 rounded-2xl'>
                ...
                <div className='col-span-1 bg-[#F5F5DC] p-3 rounded-2xl'>
                ...
                <div className='col-span-3 text-center bg-[#F5F5DC] p-3 rounded-2xl'>
