...
const MyPosts = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://krishilink-server-six.vercel.app/mypost?email=${user?.email}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://krishilink-server-six.vercel.app/crops/${id}`, {
          method: "DELETE",
        })
          .then((res) => res.json())
          .then((data) => {
  ...
  const handleUpdate = (e) => {
    ...
    fetch(`https://krishilink-server-six.vercel.app/crops/${currentpost._id}`, {
      method: "PUT",
      headers: {
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button
                      ...
                      className="btn btn-outline btn-error btn-xs ms-2"
                    >
                      Delete
                    </button>
                  </td>
